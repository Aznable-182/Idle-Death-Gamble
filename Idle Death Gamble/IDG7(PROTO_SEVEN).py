...
class Gambler():
    def __init__(self):
        ...
        self._jackpotmp3 = pygame.mixer.Sound(r'D:\CodeAndStuff\Idle Death Gamble\Music\jackpotmusicAY.mp3')
    ...
    def musicchoice(self):
        ...
        if self._music == "tol":
            self._jackpotmp3 = pygame.mixer.Sound(r'E:\CodeAndStuff\Idle Death Gamble\Music\jackpotmusicTOL.mp3')
            print("Music Changed\n")
        elif self._music == "ay":
            self._jackpotmp3 = pygame.mixer.Sound(r'E:\CodeAndStuff\Idle Death Gamble\Music\jackpotmusicAY.mp3')
            print("Music Changed\n")
